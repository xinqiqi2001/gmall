...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo>
    ...
    public Long saveOrder(OrderSubmitVo submitVo, String tradeNo) {
        ...
        rabbitTemplate
                .convertAndSend(MqConst.EXCHANGE_ORDER_EVNT,
    ...
    /**
     * 将前端传来的OrderSubmitVo对象转换成OrderInfo对象(存入数据库要用OrderInfo对象)
     *
     * @param submitVo
     * @param tradeNo
     * @return
