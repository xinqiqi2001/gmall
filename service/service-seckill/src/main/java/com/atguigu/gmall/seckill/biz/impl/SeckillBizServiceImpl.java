...
public class SeckillBizServiceImpl implements SeckillBizService {
    ...
    public String getSeckillCode(Long skuId) {
        ...
        //2022/9/22 获取当前秒杀商品信息 生成秒杀码
        SeckillGoods goodsDetail = cacheOpsService.getSeckillGoodsDetail(skuId);
